  ...
  return (function () {
  ...
  })()(
    {
        ...
        function (require, module, exports) {
          ...
          const drawParagraph = function (
            ...
            const dstRect = CanvasKit.XYWHRect(
              Math.ceil(dx),
              Math.ceil(dy),
              paragraph.skImageWidth / drawer_1.Drawer.pixelRatio,
              paragraph.skImageHeight / drawer_1.Drawer.pixelRatio
            );
            const skPaint =
              drawParagraphSharedPaint !== null &&
              drawParagraphSharedPaint !== void 0
                ? drawParagraphSharedPaint
                : new CanvasKit.Paint();
          ...
          class Paragraph extends skia_1.SkEmbindObject {
            ...
            getGlyphPositionAtCoordinate(dx, dy) {
              ...
              for (
                let index = 0;
                index < this._textLayout.glyphInfos.length;
                index++
              ) {
              ...
              for (
                let index = 0;
                index < this._textLayout.lineMetrics.length;
                index++
              ) {
                const lineMetrics = this._textLayout.lineMetrics[index];
                const isLastLine =
                  index === this._textLayout.lineMetrics.length - 1;
                const left = 0;
            ...
            getClosestGlyphInfoAtCoordinate(dx, dy) {
              return this.getGlyphInfoAt(
                this.getGlyphPositionAtCoordinate(dx, dy).pos
              );
            }
            /**
            ...
            getGlyphInfoAt(index) {
              var _a;
              this._textLayout.measureGlyphIfNeeded();
              return (_a = this._textLayout.glyphInfos[index]) !== null &&
                _a !== void 0
                ? _a
                : null;
            }
            getHeight() {
              ...
              for (let i = 0; i < lineMetrics.length; i++) {
                height +=
                  lineMetrics[i].height * lineMetrics[i].heightMultiplier;
            ...
            getLineNumberAt(index) {
              var _a, _b;
              return (_b =
                (_a = this.getLineMetricsOfRange(index, index)[0]) === null ||
                _a === void 0
                  ? void 0
            ...
            getLineMetricsAt(lineNumber) {
              var _a;
              return (_a = this._textLayout.lineMetrics[lineNumber]) !== null &&
                _a !== void 0
                ? _a
                : null;
            }
            getLineMetricsOfRange(start, end) {
              ...
              this._textLayout.lineMetrics.forEach((it) => {
                ...
                const hasIntersection =
                  range0[1] >= range1[0] && range1[1] >= range0[0];
                if (hasIntersection) {
                  lineMetrics.push(it);
                }
              });
            ...
            getMaxIntrinsicWidth() {
              ...
              for (let i = 0; i < lineMetrics.length; i++) {
                maxWidth = Math.max(
                  maxWidth,
                  (_a = lineMetrics[i].justifyWidth) !== null && _a !== void 0
                    ? _a
                    : lineMetrics[i].width
                );
              }
            ...
            getRectsForRange(start, end, hStyle, wStyle) {
              ...
              this._textLayout.lineMetrics.forEach((it) => {
                ...
                if (hasIntersection) {
                  ...
                  for (
                    let index = intersecRange[0];
                    index < intersecRange[1];
                    index++
                  ) {
                    const glyphInfo = this._textLayout.glyphInfos[index];
                    if (glyphInfo) {
              ...
              if (result.length === 0) {
                ...
                const lastLine =
                  this._textLayout.lineMetrics[
                    this._textLayout.lineMetrics.length - 1
                  ];
                if (
      ...
      2: [
        function (require, module, exports) {
          ...
          class ParagraphBuilder extends skia_1.SkEmbindObject {
            static MakeFromFontCollection(
              ...
              var _a;
              const fontFamilies =
                (_a = style.textStyle) === null || _a === void 0
                  ? void 0
                  : _a.fontFamilies;
              if (fontFamilies && fontFamilies[0] === "MiniTex") {
                logger_1.logger.info(
                  "use minitex paragraph builder.",
                  fontFamilies
                );
                ...
                fontFamilies &&
                iconFonts &&
                iconFonts[fontFamilies[0]]
              ) {
                logger_1.logger.info(
                  "use fontPaths paragraph builder.",
                  fontFamilies
                );
                ...
                logger_1.logger.info(
                  "use skia paragraph builder.",
                  fontFamilies
                );
                return originMakeFromFontCollectionMethod(
                  style,
                  fontCollection
                );
              }
        ...
        { "../impl/span": 6, "../logger": 8, "./paragraph": 1, "./skia": 3 },
      ],
      3: [
        function (require, module, exports) {
          "use strict";
          ...
          // found in the LICENSE file.
          Object.defineProperty(exports, "__esModule", { value: true });
          exports.TextHeightBehavior =
            exports.DecorationStyle =
            exports.FontSlant =
            exports.FontWidth =
            exports.FontWeight =
            exports.LineThroughDecoration =
            exports.OverlineDecoration =
            exports.UnderlineDecoration =
            exports.NoDecoration =
            exports.TextAlign =
            exports.Affinity =
            exports.RectWidthStyle =
            exports.RectHeightStyle =
            exports.TextDirection =
            exports.TextBaseline =
            exports.StrokeJoin =
            exports.StrokeCap =
            exports.PlaceholderAlignment =
            exports.SkEmbindObject =
              void 0;
          ...
          (function (RectHeightStyle) {
            ...
            RectHeightStyle[(RectHeightStyle["IncludeLineSpacingMiddle"] = 2)] =
              "IncludeLineSpacingMiddle";
            RectHeightStyle[(RectHeightStyle["IncludeLineSpacingTop"] = 3)] =
              "IncludeLineSpacingTop";
            RectHeightStyle[(RectHeightStyle["IncludeLineSpacingBottom"] = 4)] =
          ...
          (function (TextHeightBehavior) {
            ...
            TextHeightBehavior[(TextHeightBehavior["DisableFirstAscent"] = 1)] =
              "DisableFirstAscent";
            TextHeightBehavior[(TextHeightBehavior["DisableLastDescent"] = 2)] =
              "DisableLastDescent";
            TextHeightBehavior[(TextHeightBehavior["DisableAll"] = 3)] =
              "DisableAll";
          })(
            TextHeightBehavior ||
      ...
      4: [
          ...
          class Drawer {
            ...
            initCanvas() {
              if (!Drawer.sharedRenderCanvas) {
                Drawer.sharedRenderCanvas = (0, util_1.createCanvas)(
                  Math.min(4000, 1000 * Drawer.pixelRatio),
                  Math.min(4000, 1000 * Drawer.pixelRatio)
                );
                Drawer.sharedRenderContext =
                  Drawer.sharedRenderCanvas.getContext("2d", {
            ...
            draw() {
              this.initCanvas();
              const width = (0, util_1.convertToUpwardToPixelRatio)(
                this.paragraph.getMaxWidth() * Drawer.pixelRatio,
                Drawer.pixelRatio
              );
              const height = (0, util_1.convertToUpwardToPixelRatio)(
                ...
                if (span instanceof span_1.TextSpan) {
                  ...
                  while (spanUndrawLength > 0) {
                    ...
                    if (
                      ...
                      const trimLength = (0, util_1.isSquareCharacter)(
                      ...
                      currentDrawText.push(
                        ...Array.from(
                          (_a = this.paragraph.paragraphStyle.ellipsis) !==
                            null && _a !== void 0
                            ? _a
                            : "..."
                        )
                    ...
                    let drawingLeft = (() => {
                      ...
                      if (
                        ...
                        const textAlign =
                          (_a = this.paragraph.paragraphStyle.textAlign) ===
                            null || _a === void 0
                            ? void 0
                            : _a.value;
                        const textDirection =
                          (_b = this.paragraph.paragraphStyle.textDirection) ===
                            null || _b === void 0
                            ? void 0
                            : _b.value;
                        if (textAlign === skia_1.TextAlign.Center) {
                          linesDrawingRightBounds[currentDrawLine.lineNumber] =
                            (this.paragraph.getMaxWidth() -
                              currentDrawLine.width) /
                            2.0;
                        } else if (
                          textAlign === skia_1.TextAlign.Right ||
                          ...
                          linesDrawingRightBounds[
                            currentDrawLine.lineNumber
                          ] = 0;
                        }
                      }
                      return linesDrawingRightBounds[
                        currentDrawLine.lineNumber
                      ];
                    })();
                    const drawingRight =
                    ...
                    linesDrawingRightBounds[currentDrawLine.lineNumber] =
                      drawingRight;
                    const textTop =
                      currentDrawLine.baseline *
                        currentDrawLine.heightMultiplier -
                      span.letterBaseline;
                    const textBaseline =
                      currentDrawLine.baseline *
                      currentDrawLine.heightMultiplier;
                    ...
                    if (span.style.shadows && span.style.shadows.length > 0) {
                      ...
                      context.shadowOffsetX =
                        (_c =
                          (_b = span.style.shadows[0].offset) === null ||
                          _b === void 0
                            ? void 0
                            : _b[0]) !== null && _c !== void 0
                          ? _c
                      ...
                      context.shadowOffsetY =
                        (_e =
                          (_d = span.style.shadows[0].offset) === null ||
                          _d === void 0
                            ? void 0
                            : _d[1]) !== null && _e !== void 0
                          ? _e
                          : 0;
                      context.shadowBlur =
                        (_f = span.style.shadows[0].blurRadius) !== null &&
                        _f !== void 0
                          ? _f
                          : 0;
                    }
                    ...
                    if (this.paragraph.iconFontData) {
                      for (
                        let index = 0;
                        index < currentDrawText.length;
                        index++
                      ) {
                        const currentDrawLetter = currentDrawText[index];
                        const letterWidth =
                          (_g = span.style.fontSize) !== null && _g !== void 0
                            ? _g
                            : 14;
                        this.fillIcon(
                          context,
                      ...
                      for (
                        ...
                        const letterWidth =
                          context.measureText(currentDrawLetter).width;
                        if (
                          span.hasWordSpacing() &&
                          currentDrawLetter === " " &&
                        ...
                        if (
                          !(0, util_1.isEnglishWord)(currentDrawText[index])
                        ) {
            ...
            fillIcon(context, text, fontSize, x, y) {
              var _a;
              const svgPath =
                (_a = this.paragraph.iconFontMap) === null || _a === void 0
                  ? void 0
                  : _a[text];
              if (!svgPath) {
                console.log(
            ...
            drawDecoration(span, context, options) {
              ...
              if (span.style.decoration) {
                ...
                context.lineWidth =
                  ((_a = span.style.decorationThickness) !== null &&
                  _a !== void 0
                    ? _a
                    : 1) *
                  Math.max(
                    1,
                    ((_b = span.style.fontSize) !== null && _b !== void 0
                      ? _b
                      : 12) / 14
                  );
                const decorationStyle =
                  (_c = span.style.decorationStyle) === null || _c === void 0
                    ? void 0
                    : _c.value;
                ...
                if (span.style.decoration & skia_2.OverlineDecoration) {
                  ...
                  context.moveTo(
                    drawingLeft,
                    currentDrawLine.yOffset + textTop
                  );
                  context.lineTo(
                    drawingRight,
                    currentDrawLine.yOffset + textTop
        ...
        { "../adapter/skia": 3, "../logger": 8, "../util": 11, "./span": 6 },
      ],
      5: [
        function (require, module, exports) {
          "use strict";
          ...
          class LetterMeasurer {
            ...
            static measureNormalLetter(letter, context) {
              var _a;
              const width =
                (_a = this.widthFromCache(context, letter)) !== null &&
                _a !== void 0
                  ? _a
            ...
            static measureSquareCharacter(context) {
              var _a;
              const width =
                (_a = this.widthFromCache(context, "测")) !== null &&
                _a !== void 0
                  ? _a
                  : context.measureText("测").width;
            ...
            static widthFromCache(context, word) {
              ...
              return (_a = this.measureLRUCache[cacheKey]) === null ||
                _a === void 0
                ? void 0
                : _a.width;
            }
            static setWidthToCache(context, word, width) {
              ...
              if (
                Object.keys(this.measureLRUCache).length >
                this.LRUConfig.maxCacheCount
              ) {
                this.clearCache();
              }
            }
            static clearCache() {
              const keys = Object.keys(this.measureLRUCache).sort((a, b) => {
                return this.measureLRUCache[a].useCount >
                  this.measureLRUCache[b].useCount
                  ? 1
                  : -1;
              });
              keys
                .slice(
                  0,
                  this.LRUConfig.maxCacheCount - this.LRUConfig.minCacheCount
                )
                .forEach((it) => {
            ...
            layout(layoutWidth, forceCalcGlyphInfos = false) {
              ...
              let currentLineMetrics = {
                ...
                heightMultiplier: Math.max(
                  1,
                  ((_a = this.paragraph.paragraphStyle.heightMultiplier) !==
                    null && _a !== void 0
                    ? _a
                    : 1.5) / 1.5
                ),
                width: 0,
                justifyWidth:
                  ((_b = this.paragraph.paragraphStyle.textAlign) === null ||
                  _b === void 0
                    ? void 0
                    : _b.value) === skia_1.TextAlign.Justify
                    ? layoutWidth
                    : undefined,
                left: 0,
                yOffset: 0,
              ...
              spans.forEach((span) => {
                ...
                if (span instanceof span_1.TextSpan) {
                  ...
                  const matrics = TextLayout.sharedLayoutContext.measureText(
                    span.originText
                  );
                  let iconFontWidth = 0;
                  if (this.paragraph.iconFontData) {
                    const fontSize =
                      (_a = span.style.fontSize) !== null && _a !== void 0
                        ? _a
                        : 14;
                    ...
                    const mHeight =
                      TextLayout.sharedLayoutContext.measureText("M").width;
                  ...
                  if (this.paragraph.iconFontData) {
                    ...
                    if (span instanceof span_1.NewlineSpan) {
                      ...
                      if (
                        ((_c =
                          (_b = span.style.fontStyle) === null || _b === void 0
                            ? void 0
                            : _b.slant) === null || _c === void 0
                          ? void 0
                          : _c.value) === skia_2.FontSlant.Italic
                      ) {
                    ...
                    if (
                      Math.abs(advances[advances.length - 1] - layoutWidth) <
                        10 &&
                      layoutWidth === this.previousLayoutWidth
                    ) {
                    ...
                    for (
                      let index = 0;
                      index < span.charSequence.length;
                      index++
                    ) {
                      const letter = span.charSequence[index];
                      currentWord += letter;
                      ...
                      let spanEnded =
                        span.charSequence[index + 1] === undefined;
                      let nextWord =
                        (_d = currentWord + span.charSequence[index + 1]) !==
                          null && _d !== void 0
                          ? _d
                          : "";
                      if (advances[index + 1] === undefined) {
                        ...
                        currentWordWidth +=
                          advances[index + 1] - advances[index];
                      }
                      if (advances[index + 2] === undefined) {
                        ...
                        nextWordWidth =
                          currentWordWidth +
                          (advances[index + 2] - advances[index + 1]);
                      }
                      currentWordLength += 1;
                      canBreak = true;
                      forceBreak = false;
                      ...
                      const currentGlyphInfo = {
                        graphemeLayoutBounds: (0, util_1.valueOfRectXYWH)(
                          currentGlyphLeft,
                          currentGlyphTop,
                          currentGlyphWidth,
                          currentGlyphHeight
      ...
      6: [
        function (require, module, exports) {
          ...
          class TextSpan extends Span {
            ...
            hasLetterSpacing() {
              return (
                this.style.letterSpacing !== undefined &&
                this.style.letterSpacing > 1
              );
            }
            hasWordSpacing() {
              return (
                this.style.wordSpacing !== undefined &&
                this.style.wordSpacing > 1
              );
            }
            hasJustifySpacing(paragraphStyle) {
              var _a;
              return (
                ((_a = paragraphStyle.textAlign) === null || _a === void 0
                  ? void 0
                  : _a.value) === skia_1.TextAlign.Justify
              );
            }
            ...
            toCanvasFont() {
              var _a, _b, _c, _d;
              let font = `${this.style.fontSize}px system-ui, -apple-system, BlinkMacSystemFont, segoe ui, Roboto, Helvetica, Arial, sans-serif, apple color emoji, segoe ui emoji, segoe ui symbol`;
              const fontWeight =
                (_b =
                  (_a = this.style.fontStyle) === null || _a === void 0
                    ? void 0
                    : _a.weight) === null || _b === void 0
                  ? void 0
                  : _b.value;
              ...
              const slant =
                (_d =
                  (_c = this.style.fontStyle) === null || _c === void 0
                    ? void 0
                    : _c.slant) === null || _d === void 0
                  ? void 0
                  : _d.value;
              if (slant) {
                switch (slant) {
          ...
          class MiniTex {
            static install(canvasKit, pixelRatio, embeddingFonts, iconFonts) {
              ...
              canvasKit.ParagraphBuilder.MakeFromFontCollection = function (
                ...
                return paragraph_builder_1.ParagraphBuilder.MakeFromFontCollection(
                  originMakeFromFontCollectionMethod,
                  style,
                  fontCollection,
                  embeddingFonts,
              ...
              const originDrawParagraphMethod =
                canvasKit.Canvas.prototype.drawParagraph;
      ...
      9: [
        function (require, module, exports) {
          ...
          const installPolyfill = (canvasKit) => {
            ...
            canvasKit.TextDirection =
              new polyfill_types_1.TextDirectionEnumValues();
            canvasKit.TextBaseline =
              new polyfill_types_1.TextBaselineEnumValues();
            canvasKit.RectHeightStyle =
              new polyfill_types_1.RectHeightStyleEnumValues();
            canvasKit.RectWidthStyle =
              new polyfill_types_1.RectWidthStyleEnumValues();
            ...
            canvasKit.DecorationStyle =
              new polyfill_types_1.DecorationStyleEnumValues();
            canvasKit.TextHeightBehavior =
              new polyfill_types_1.TextHeightBehaviorEnumValues();
            // Paragraph Constants
        ...
        { "./adapter/skia": 3, "./polyfill.types": 10 },
      ],
      10: [
        function (require, module, exports) {
          "use strict";
          Object.defineProperty(exports, "__esModule", { value: true });
          exports.TextHeightBehaviorEnumValues =
            exports.DecorationStyleEnumValues =
            exports.FontSlantEnumValues =
            exports.FontWidthEnumValues =
            exports.FontWeightEnumValues =
            exports.AffinityEnumValues =
            exports.RectWidthStyleEnumValues =
            exports.RectHeightStyleEnumValues =
            exports.TextBaselineEnumValues =
            exports.TextDirectionEnumValues =
            exports.TextAlignEnumValues =
            exports.FontHinting =
            exports.FontEdging =
              void 0;
          var FontEdging;
          (function (FontEdging) {
            ...
            FontEdging[(FontEdging["SubpixelAntiAlias"] = 2)] =
              "SubpixelAntiAlias";
      ...
      11: [
        function (require, module, exports) {
          ...
          exports.createCanvas =
            exports.convertToUpwardToPixelRatio =
            exports.isPunctuation =
            exports.isSquareCharacter =
            exports.isEnglishWord =
            exports.valueOfRectXYWH =
            exports.valueOfRGBAInt =
            exports.colorToHex =
              void 0;
          const colorToHex = (rgbaColor) => {
            ...
            const hexColor =
              "#" + padHex(r) + padHex(g) + padHex(b) + padHex(a);
            return hexColor;
          };
          ...
          function convertToUpwardToPixelRatio(number, pixelRatio) {
            ...
            return remainder === 0
              ? upwardInt
              : upwardInt + (pixelRatio - remainder);
          }
